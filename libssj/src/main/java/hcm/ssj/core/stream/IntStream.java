...
public class IntStream extends Stream
{
    ...
    public IntStream(int num, int dim, int bytes, double sr)
    {
        this.num = num;
        this.dim = dim;
        this.bytes = bytes;
    ...
    public int[] ptr()
{
    ...
    public IntStream select(int[] new_dims)
    {
        ...
        IntStream slice = new IntStream(num, new_dims.length, bytes, sr);
        slice.source = source;
    ...
    public IntStream select(int new_dim)
    {
        ...
        IntStream slice = new IntStream(num, 1, bytes, sr);
        slice.source = source;
    ...
    public Stream clone()
    {
        IntStream copy = new IntStream(num, dim, bytes, sr);

 ...
 */
public class BatteryProvider extends SensorProvider
{
	public class Options extends OptionList
	{
		public final Option<Integer> sampleRate = new Option<>("sampleRate", 1, Cons.Type.INT, "");
	...
	protected void defineOutputClasses(Stream stream_out)
	{
		...
		stream_out.dataclass[0] = "Battery";
	}
}

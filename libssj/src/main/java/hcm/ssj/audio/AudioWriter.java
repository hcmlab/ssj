...
public class AudioWriter extends Mp4Writer
{
    ...
    public final void enter(Stream[] stream_in)
    {
        ...
        switch (stream_in[0].type)
        {
            ...
            case FLOAT:
            {
                ...
                {
                    Log.e(_name, "Audio format not supported");
                }
                break;
            }
            default:
        ...
        Log.d(_name, "Format: " + dataFormat.toString());
        ...
        double d = stream_in[0].num * stream_in[0].step;
        iFrameRate = (int) (1 / d + 0.5);
        byaShuffle = new byte[iSampleNumber / iFrameRate];
        prepareEncoder();
    ...
    protected final void consume(Stream[] stream_in)
    {
        switch (dataFormat)
        {
            ...
            default:
            {
                Log.e(_name, "Data format not supported");
                break;
            }
        }
    }

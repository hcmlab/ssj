...
public class GSRArousalEstimation extends Transformer
{
	...
	{
		public double windowSizeShortTerm = 5; // Size of short time window in seconds
		public double windowSizeLongTerm  = 60; // Size of long time window in seconds
	}
	...
	public void enter(Stream[] stream_in, Stream stream_out)
	{
		...
		_detrend.options.norm = MvgNorm.Norm.SUB_MIN;
		_detrend.options.method = MvgNorm.Method.SLIDING;
		_detrend.options.windowSize = 60;
		...
		_detrendNormMinMax.options.norm = MvgNorm.Norm.MIN_MAX;
		_detrendNormMinMax.options.rangeA = 0;
		_detrendNormMinMax.options.rangeB = 1;
		_detrendNormMinMax.options.method = MvgNorm.Method.SLIDING;
		_detrendNormMinMax.options.windowSize = 60;
		...
		_mvgAvgLongTerm.options.format = MvgAvgVar.Format.AVERAGE;
		_mvgAvgLongTerm.options.method = MvgAvgVar.Method.SLIDING;
		_mvgAvgLongTerm.options.window = 90;
		...
		_butfiltLongTerm.options.zero = true;
		_butfiltLongTerm.options.norm = false;
		_butfiltLongTerm.options.low = 0.1;
		_butfiltLongTerm.options.order = 3;
		_butfiltLongTerm.options.type = Butfilt.Type.LOW;
		...
		_mvgAvgShortTerm.options.format = MvgAvgVar.Format.AVERAGE;
		_mvgAvgShortTerm.options.method = MvgAvgVar.Method.SLIDING;
		_mvgAvgShortTerm.options.window = 5;
		...
		_mvgAvgCombination.options.format = MvgAvgVar.Format.AVERAGE;
		_mvgAvgCombination.options.method = MvgAvgVar.Method.SLIDING;
		_mvgAvgCombination.options.window = 30;

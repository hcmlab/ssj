...
public class AudioTest extends ApplicationTestCase<Application>
{
    ...
    public void testWriter() throws Exception
    {
        ...
        audioProvider.options.audioFormat = AudioFormat.ENCODING_PCM_16BIT;
        audioProvider.options.channelConfig = AudioFormat.CHANNEL_IN_STEREO;
        audioProvider.options.sampleRate = 8000;
        audioProvider.options.scale = true;
        microphone.addProvider(audioProvider);
        //consumer
        AudioWriter audioWriter = new AudioWriter();
        audioWriter.options.audioFormat = AudioFormat.ENCODING_PCM_16BIT;
        audioWriter.options.file = file;
    ...
    public void testSpeechrate() throws Exception
    {
        ...
        sr.options.thresholdVoicedProb = 0.3f;
